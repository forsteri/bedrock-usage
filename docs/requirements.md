...
- 対応モデル (Bedrock On-Demand / Standard Tier):
  ...
  |---|---|---|---|
  | Claude Opus 4.6 / 4.5 | `anthropic.claude-opus-4-6`, `4-5` | $0.005 | $0.025 |
  | Claude Opus 4 / 4.1 | `anthropic.claude-opus-4` | $0.015 | $0.075 |
  | Claude Sonnet 4.6 / 4.5 / 4 | `anthropic.claude-sonnet-4-6`, `4-5`, `4` | $0.003 | $0.015 |
